...
En la siguiente imagen se muestra los principales componentes del Visor Geográfico Ambiental.
...
El menú lateral se encuentra enumerado como **{==(1)==}**, a la izquierda del visor. En este menú se encuentra los paneles de despliegue de capas, así como aplicaciones específicas. También se encuentra la herramienta de despliegue de las opciones de compartir en redes sociales, autenticación, ayuda y créditos de conexión e interoperabilidad con Sistemas de Información Geográfica.
...
## Panel de depsliegue de mapas base
