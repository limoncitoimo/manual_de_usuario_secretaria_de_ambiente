...
<figure markdown>
![Interfaz Bienvenida](images/002-Interfaz.png)
...
Corresponde al numeral **{==(2)==}**, en este panel flotante se lleva a cabo el despliegue de la leyenda, así como de la identificación y medidas, entre otra información releveante.
...
La barra de herramientas está constituida por el numeral **{==(4)==}**, y básicamente muestra todas las herramientas disponibles para usuario como la navegación, consulta, medición, localización y generación de la cadena de servicios.

## Panel de despliegue de mapas base

Corresponde al numeral **{==(5)==}** y permite acceder al listado de mapas base que pueden utilizarse como referencia junto con las capas temáticas ambientales.

## Barra de estado de coordenadas

La barra de estado se ubica en la parte inferior del Visor Geográfico y se encuentran los indicadores del mapa, que permiten al usuario conocer la escala aproximada del mapa actual, numeral **{==(6)==}**, las coordenadas geográficas o planas, la vista general del mapa y los avisos en la herramienta.
